...
def plot_solutions(mu=0.0, x0=[2, 0.5], tf=50.0, N=200):
	...
	plt.title("Time variation of Van der Pol equation for $\mu$=" + str(mu), fontsize=12)
...
def plot_limit_cycle(mu=0.0, x0=[2, 0.5], tf=50.0, N=200):
	...
	plt.title("Solution of Van der Pol equation for $\mu$=" + str(mu), fontsize=12)
...
if __name__ == '__main__':
	all_mu_limit_cycle(mu=[0.0, 0.01, 1.0, 3.0, 10.0], x0=[2, 0.5], tf=50.0, N=2000)
